                ...
                childrens: [
                    {
                        ...
                        icon: 'pi pi-fw pi-plus',
                        to: { name: 'webkassa-merchant-api', hash: "#webkassa-merchant-api-info" }
                    },
                    {
                        label: 'Этап 3.2. Получение подтверждения по платежу с последующей оплатой (Pay).',
                        icon: 'pi pi-fw pi-plus',
                        to: { name: 'webkassa-merchant-api', hash: "#webkassa-merchant-api-pay" }
                    },
                    {
                        label: 'Этап 3.3. Уведомление о статусе платежа (Notify).',
                        icon: 'pi pi-fw pi-plus',
                        to: { name: 'webkassa-merchant-api', hash: "#webkassa-merchant-api-notify" }
                    },
                    {
                        label: 'Этап 3.4. Отмена платежа (Cancel).',
                        icon: 'pi pi-fw pi-plus',
                        to: { name: 'webkassa-merchant-api', hash: "#webkassa-merchant-api-cancel" }
                    },
                    {
                        label: 'Этап 3.5. Отчет о платежах (Statement).',
                        icon: 'pi pi-fw pi-plus',
                        to: { name: 'webkassa-merchant-api', hash: "#webkassa-merchant-api-statement" }
                    },
                    {
                        label: 'Этап 3.6. Узнать статус платежа(необязательный) (Status).',
                        icon: 'pi pi-fw pi-plus',
                        to: { name: 'webkassa-merchant-api', hash: "#webkassa-merchant-api-status" }
                    },
                    {
                        label: 'Этап 3.7. Фискальные данные(необязательный) (Fiscalization).',
                        icon: 'pi pi-fw pi-plus',
                        to: { name: 'webkassa-merchant-api', hash: "#webkassa-merchant-api-fiscalization" }
                    },
                ]
            },
        ]
